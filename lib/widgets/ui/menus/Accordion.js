enyo.kind({
	...
	published: {
		...
		itemNameField: "name",
		itemKeyField:"key",
		itemHeight: 40 // the height of single menu child item.
	},
	events: {
...
enyo.kind({
	...
	create: enyo.inherit(function (sup) {
		return function () {
			...
			var headerComponent = { name:"accordionItemHeader", kind: "widgets.menus.accordion.ItemHeader", components:[{content: this.headerTitle}] };
