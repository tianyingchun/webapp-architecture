enyo.kind({
	...
	_drawCell: function (rowIndex, colIndex, value) {
		...
		if (this.model == "view") {
			cellValue = {tag:"span", allowHtml:true, content:value};
		}
