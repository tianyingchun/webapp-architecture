enyo.kind({
	...
	components: [
		{ classes: "search-input", name:"searchTxt", placeholder: Master.locale.get("SEARCH_HINT", "placeholder"), kind: "onyx.Input"},
		{ classes: "search-button", ontap:"goSearch", kind: "onyx.Button",content: Master.locale.get("SEARCH","button")},
		{ classes: "show-advanced-search", ontap:"showSearchFilterPanel", content: Master.locale.get("REFINE_SEARCH","label")},
