    ...
    enyo.setPath("Master.ModelSupport", {
        ...
        _defaultApiOpts: {
            ...
            headers: function() {
                return {
                    ...
                    "Authorization": Master.session.getToken()
                };
            },
        ...
        parse: function(data, options) {
            ...
            if (options) {
                ...
                if (customizedDto) {
                    uniformData = enyo.call(this, customizedDto, [uniformData, options]);
                }
            }
        ...
        _resetRequestOptions: function(options) {
            ...
            opts.success = enyo.bind(this, "didSuccessFn");
            opts.fail = enyo.bind(this, "didFailedFn");
